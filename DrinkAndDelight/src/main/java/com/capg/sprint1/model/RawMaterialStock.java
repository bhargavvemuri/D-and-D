...
public RawMaterialStock(String orderId, String name, double pricePerUnit, double quantityValue, double quantityUnit,
		double price, String warehouseId, Date deliveryDate, Date manufactureDate, Date expirydate, String qualityCheck,
		Date processDate) {
	super();
...
public String toString() {
	return "RawMaterialStock [orderId=" + orderId + ", name=" + name + ", pricePerUnit=" + pricePerUnit
			...
			+ ", warehouseId=" + warehouseId + ", deliveryDate=" + deliveryDate + ", manufactureDate=" + manufactureDate
			+ ", expirydate=" + expirydate + ", qualityCheck=" + qualityCheck + ", processDate=" + processDate + "]";
}
